function createUnityInstance(t, n, l) {
    ...
    document.addEventListener("webkitfullscreenchange", f),
        ...
        u.QuitCleanup = function () {
            ...
            // Tambahkan logika pengalihan setelah pembersihan selesai
            var logoutUrl = document.body.getAttribute('data-logout-url');
            window.location.href = logoutUrl; // Redirect ke dashboard
        };
    ...
    var h, m, b, p, g, w, v, y, k, _ = {
        ...
        Quit: function () {
            return new Promise(function (resolve, reject) {
                // Set flag u.shouldQuit menjadi true
                u.shouldQuit = true;

                // Definisikan fungsi u.onQuit yang akan dipanggil saat proses quit selesai
                u.onQuit = function () {
                    // Panggil fungsi u.QuitCleanup() untuk membersihkan dan melakukan cleanup
                    u.QuitCleanup();

                    // Resolve promise untuk menandakan proses quit telah selesai
                    resolve();
                };
            });
        },
            ...
            C.prototype.cleanUpCache = function () {
                ...
                return this.getMetaDataEntries().then(function (e) {
                    for (var t = e.metaDataEntries, n = e.cacheSize, r = [], o = [], a = 0; a < t.length; ++a)
                        t[a].version == u.productVersion ? o.push(t[a]) : (r.push(t[a]),
                            n -= t[a].size);
                    o.sort(function (e, t) {
            ...
            function (o, a) {
                ...
                return a && (l.control = a.control,
                    ...
                    l.enabled ? i.loadRequest(s).then(function (e) {
                        ...
                        return E("Failed to load '" + l.metaData.url + "' from indexedDB cache due to the error: " + e),
                            y(o, a)
                    }) : y(o, a)
            }
        );
                ...
                var t, n = {
                    ...
                    "zlib/inflate.js": function (e, t, n) {
                        ...
                        function j(e, t, n, r) {
                            ...
                            return null === (e = e.state).window && (e.wsize = 1 << e.wbits,
                                ...
                                r >= e.wsize ? (T.arraySet(e.window, t, n - e.wsize, e.wsize, 0),
                                    e.wnext = 0,
                                    e.whave = e.wsize) : (r < (o = e.wsize - e.wnext) && (o = r),
                                        T.arraySet(e.window, t, n - r, o, e.wnext),
                                        (r -= o) ? (T.arraySet(e.window, t, n - r, r, 0),
                                            e.wnext = r,
                        ...
                        n.inflateReset = s,
                            ...
                            n.inflate = function (e, t) {
                                var n, r, o, a, i, s, l, c, d, u, f, h, m, b, p, g, w, v, y, k, _, x, S, C, E = 0, U = new T.Buf8(4), D = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                                    ...
                                    switch (n.mode) {
                                        ...
                                        case 7:
                                            if (2048 & n.flags) {
                                                ...
                                                for (h = 0; _ = r[a + h++],
                                                    ...
                                                    _ && h < s;)
                                                    ;
                                                if (512 & n.flags && (n.check = P(n.check, r, h, a)),
                                                    s -= h,
                                                    a += h,
                                                    _)
                                                    break e
                                            ...
                                            if (n.last)
                                                ...
                                                3 & (c >>>= 1)) {
                                                    case 0:
                                                        ...
                                                        break;
                                                    case 1:
                                                        var B, B = A = void 0, A = n;
                                                        if (Z) {
                                                            for (M = new T.Buf32(512),
                                                                H = new T.Buf32(32),
                                                                B = 0; B < 144;)
                                                                A.lens[B++] = 8;
                                                            for (; B < 256;)
                                        ...
                                        case 19:
                                            for (; n.have < n.nlen + n.ndist;) {
                                                for (; g = (E = n.lencode[c & (1 << n.lenbits) - 1]) >>> 16 & 255,
                                                    w = 65535 & E,
                                                    !((p = E >>> 24) <= d);) {
                                                    if (0 === s)
                                                        break e;
                                        ...
                                        case 21:
                                            ...
                                            for (n.back = 0; g = (E = n.lencode[c & (1 << n.lenbits) - 1]) >>> 16 & 255,
                                                w = 65535 & E,
                                                !((p = E >>> 24) <= d);) {
                                                if (0 === s)
                                                    break e;
                                            ...
                                            if (g && 0 == (240 & g)) {
                                                for (v = p,
                                                    y = g,
                                                    k = w; g = (E = n.lencode[k + ((c & (1 << v + y) - 1) >> v)]) >>> 16 & 255,
                                                    w = 65535 & E,
                                                    !(v + (p = E >>> 24) <= d);) {
                                                    if (0 === s)
                                                        break e;
                                        ...
                                        case 22:
                                            ...
                                            n.was = n.length,
                                                n.mode = 23;
                                        case 23:
                                            for (; g = (E = n.distcode[c & (1 << n.distbits) - 1]) >>> 16 & 255,
                                                w = 65535 & E,
                                                !((p = E >>> 24) <= d);) {
                                                if (0 === s)
                                                    break e;
                                            ...
                                            if (0 == (240 & g)) {
                                                for (v = p,
                                                    y = g,
                                                    k = w; g = (E = n.distcode[k + ((c & (1 << v + y) - 1) >> v)]) >>> 16 & 255,
                                                    w = 65535 & E,
                                                    !(v + (p = E >>> 24) <= d);) {
                                                    if (0 === s)
                                                        break e;
                                        ...
                                        case 27:
                                            if (n.wrap) {
                                                ...
                                                if (f -= l,
                                                    e.total_out += f,
                                                    n.total += f,
                                                    f && (e.adler = n.check = (n.flags ? P : R)(n.check, o, f, i - f)),
                                                    f = l,
                                ...
                                return e.next_out = i,
                                    ...
                                    n.hold = c,
                                    n.bits = d,
                                    (n.wsize || f !== e.avail_out && n.mode < 30 && (n.mode < 27 || 4 !== t)) && j(e, e.output, e.next_out, f - e.avail_out) ? (n.mode = 31,
                                        -4) : (u -= e.avail_in,
                                            f -= e.avail_out,
                                            e.total_in += u,
                                            e.total_out += f,
                                            n.total += f,
                                            n.wrap && f && (e.adler = n.check = (n.flags ? P : R)(n.check, o, f, e.next_out - f)),
                            ...
                            n.inflateSetDictionary = function (e, t) {
                                var n, r = t.length;
                                return !e || !e.state || 0 !== (n = e.state).wrap && 11 !== n.mode ? O : 11 === n.mode && R(1, t, r, 0) !== n.check ? -3 : j(e, t, r, r) ? (n.mode = 31,
                                    -4) : (n.havedict = 1,
                                        z)
                            }
                            ,
                    ...
                    "zlib/inffast.js": function (e, t, n) {
                        ...
                        t.exports = function (e, t) {
                            var n, r, o, a, i, s, l = e.state, c = e.next_in, d = e.input, u = c + (e.avail_in - 5), f = e.next_out, h = e.output, m = f - (t - e.avail_out), b = f + (e.avail_out - 257), p = l.dmax, g = l.wsize, w = l.whave, v = l.wnext, y = l.window, k = l.hold, _ = l.bits, x = l.lencode, S = l.distcode, C = (1 << l.lenbits) - 1, E = (1 << l.distbits) - 1;
                            e: do {
                                for (_ < 15 && (k += d[c++] << _,
                                    _ += 8,
                                    k += d[c++] << _,
                    ...
                    "zlib/inftrees.js": function (e, t, n) {
                        ...
                        t.exports = function (e, t, n, r, o, a, i, s) {
                            for (var l, c, d, u, f, h, m, b, p, g = s.bits, w = 0, v = 0, y = 0, k = 0, _ = 0, x = 0, S = 0, C = 0, E = 0, U = 0, D = null, B = 0, A = new I.Buf16(16), T = new I.Buf16(16), R = null, P = 0, w = 0; w <= 15; w++)
                                A[w] = 0;
                            for (v = 0; v < r; v++)
                                A[t[n + v]]++;
                            for (_ = g,
                            ...
                            if (k < _ && (_ = k),
                                ...
                                for (; ;) {
                                    ...
                                    if (_ < w && (U & u) !== d) {
                                        for (f += y,
                                            C = 1 << (x = w - (S = 0 === S ? _ : S)); x + S < k && !((C -= A[x + S]) <= 0);)
                                            x++,
                                                C <<= 1;
                                        if (E += 1 << x,
                                            1 === e && 852 < E || 2 === e && 592 < E)
                        ...
                        for (var n in D) {
                            ...
                            if (D[n].hasUnityMarker(i))
                                return s && console.log('You can reduce startup time if you configure your web server to add "Content-Encoding: ' + n + '" response header when serving "' + s + '" file.'),
                                    (r = D[n]).worker || (o = URL.createObjectURL(new Blob(["this.require = ", r.require.toString(), "; this.decompress = ", r.decompress.toString(), "; this.onmessage = ", function (e) {
                                        e = {
                                            id: e.data.id,
                        ...
                        if ("undefined" == typeof unityFramework || !unityFramework) {
                            ...
                            for (e in t) {
                                ...
                                if (u.frameworkUrl.endsWith("." + r[0]))
                                    return n = "Unable to parse " + u.frameworkUrl + "!",
    ...
    return new Promise(function (e, t) {
        var n;
        u.SystemInfo.hasWebGL ? 1 == u.SystemInfo.hasWebGL ? (n = 'Your browser does not support graphics API "WebGL 2" which is required for this content.',
            "Safari" == u.SystemInfo.browser && parseInt(u.SystemInfo.browserVersion) < 15 && (u.SystemInfo.mobile || 1 < navigator.maxTouchPoints ? n += "\nUpgrade to iOS 15 or later." : n += "\nUpgrade to Safari 15 or later."),
            t(n)) : u.SystemInfo.hasWasm ? (u.startupErrorHandler = t,
                l(0),
